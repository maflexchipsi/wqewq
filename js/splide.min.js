...
t = function() {
    ...
    function e(n, t, i) {
        if (n)
            for (var r = Object.keys(n), u = (r = i ? r.reverse() : r,
            0); u < r.length; u++) {
                var o = r[u];
      ...
      , _t = Object.freeze({
        ...
        Options: function(t, n, r) {
            ...
            function f() {
                ...
                ,
                s(o).filter(n)[0] || []))[0] !== i && function(n) {
                    (n = r.breakpoints[n] || u).destroy ? (t.options = u,
                ...
                n = function at(u, i, r, o) {
                    ...
                    var L = {
                        ...
                        isWithin: function(n, t) {
                            return n = un(n - i),
                            (n = m || !d.rewind && !u.is(ct) ? n : $(n, u.length - n)) <= t
                        }
                    };
                    return L
                }(r, t, i, n),
        ...
        Layout: function(n, t, i) {
            ...
            function g() {
                ...
                u && u.width === n.width && u.height === n.height || (C(d, "height", function() {
                    var n = "";
                    return r && (Q(n = y(), "height or heightRatio is missing."),
                    n = "calc(" + n + " - " + m(!1) + " - " + m(!0) + ")"),
                    n
                }()),
        ...
        Clones: function(c, n, f) {
                ...
                (t = p()) && (function(u) {
                    ...
                    if (e) {
                        ...
                        k(o.slice(-u), o.slice(0, u)).forEach((function(n, t) {
                            var i = t < u
                              , r = function(n, t) {
                                return A(n = n.cloneNode(!0), f.classes.clone),
            ...
            function p() {
                ...
                H(n)),
                i = (t && rn(G(a.track)[o("width")] / t) || f[o("autoWidth")] && c.length || f.perPage) * (f.drag ? (f.flickMaxPages || 1) + 1 : 2)) : i = 0,
                i
            }
            return {
                mount: function() {
        ...
        Move: function(e, c, f) {
            ...
            function _(n, t) {
                ...
                return t ? function(n) {
                    return f.trimSpace && e.is(et) && (n = en(n, 0, v(l() - o()))),
                    n
                }(i) : i
            }
            function b() {
        ...
        Sync: function(u, n, i) {
            ...
            function t() {
                ...
                i.isNavigation && ((t = (n = Pn(u)).on)("click", f),
                t(_n, a),
                t([ln, xn], c),
                j(r, $n, "menu"),
                o.push(n),
    ...
    return i = function() {
        function i(n, t) {
            ...
            this.f = {},
            this.a = {},
            Q(n = D(n) ? q(document, n) : n, n + " is invalid."),
            this.root = n,
            l(bt, i.defaults),
            l(l(this.f, bt), t || {})
        }
